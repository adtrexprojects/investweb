...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>King Adebuss Enterprises </title>
		...
		<!-- CSS here -->
            ...
            <link rel="stylesheet" href="assets/css/background-head.css">
   </head>
<style type="text/css">
   ...
   <body>
                    ...
                    <div  class="container-fluid">
                        <div  class="row align-items-center">
                            ...
                            <div  class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <a href="index.html"><img width="105" src="assets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                            ...
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="#" class="btn header-btn">Invest Now </a>
                                </div>
                            </div>
                            </div>   
                            <!-- Mobile Menu -->
                            <div class="col-12">
                                <div style="margin-top: -25px;" class="mobile_menu d-block d-lg-none"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    padding-top: 0px;
    height: 600px;
    background-image: -webkit-linear-gradient(rgba(15, 83, 154, 0.5), rgba(15, 83, 154, 0.5)), url(https://res.cloudinary.com/de8awjxjn/image/upload/v1603053412/hero_img.jpg);
        background-position: center center;
    background-repeat: no-repeat;
    background-size: cover;
    background-color:#464646;
    color: #fff;
    font-family: 'Cormorant Garamond', serif;" class="slider-area slider-height home-page-1"  >
            <div class="slider-active">
                <!-- Single Slider -->
                <div class="single-slide" align="center">
                    <div class="width-slide">
                        <div class="hero__caption">
                            <p style="color: #fff" >Achieve your financial goal</p>
                            <h1  style="color: #fff" >KINGADEBUSS ENTERPRISES</h1>
                            <!-- Hero Btn -->
                            <a href="apply.html" class="btn header-btn" style="color: #fff" >INVEST now</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <a href="apply.html" class="btn header-btn">Invest Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <!-- about-img -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.html">Business</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.html">Commercial</a></h5>
                                <p>Consectetur adipisicing elit, sed doeiusmod tempor incididunt ut labore et dolore</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="select-form">
                                <div class="select-itms">
                                    <select name="select" id="select1">
                                        <option value="">Amount to Invest</option>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | King Adebuss Enterprises
