...
<div class="content">
  ...
  <div class="pass-form" align="center">
    ...
    <?php 
                   if(isset($_SESSION['pass_settings_error'])){
                    echo $_SESSION['pass_settings_error'];$_SESSION['pass_settings_error']='';
                   }  ?>
    <form action="forms/form_settings.php" method="post">
    <div>
  ...
  <button name="SubmitPassword" align="center">SAVE</button>
</form>
</div>
  </div>
  </div>
